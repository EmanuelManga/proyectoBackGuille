...
class ProductController {
    async getProductRender(req, res) {
        ...
        try {
            ...
            return res.status(200).render("home", { productos: objRender.products, pagination: objRender.pagination, links: objRender.links, name: objRender.name, isLoged: objRender.isLoged });
        } catch (error) {
